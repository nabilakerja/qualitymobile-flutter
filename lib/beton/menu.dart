...
import 'package:hki_quality/beton/approval_material_list.dart';
import 'package:hki_quality/beton/document_list.dart';
import 'package:hki_quality/beton/pelaksanaan_list.dart';
import 'package:hki_quality/beton/pengujian_header_list.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PreferredSize(
          ...
          child: AppBarWithShadow(title: "Pekerjaan Struktur Beton",),
        ),
      body: ListView(
                     ...
                     Row(
                      ...
                      children: [
                        ItemKategori(
                          ...
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ListApprovalMaterialBeton()));
                            },
                        ),
                        ItemKategori(
                          title: "Berita Acara",
