...
class ListApprovalMaterialAgregatA extends StatelessWidget {
  ...
  ListApprovalMaterialAgregatA(String selectedValue, {super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: 'Approval Material Pekerjaan Agregat A',
        ),
      body: Container(
                  ...
                  onChanged: (String? selectedValue) {
                    ...
                    if (selectedValue != null) {
                      ...
                      switch (selectedValue) {
                        case 'pageA':
                          // Perform any specific action for Agregat A here
                          // For example, update the state or execute a function
                          // In this case, you might not need to navigate to a new page
                          break;
                        case 'pageB':
