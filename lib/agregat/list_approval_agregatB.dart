...
import 'package:hki_quality/agregat/approval_material_agregat_b.dart';
...
class ListApprovalMaterialAgregatB extends StatelessWidget {
  ...
  ListApprovalMaterialAgregatB(String selectedValue, {super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: BubbleButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const ApprovalMaterialAgregatBFormPage()));
              },
            ),
    );
  }
