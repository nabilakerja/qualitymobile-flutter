...
class ListApprovalMaterialRigid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: CustomAppBar(
        title: 'List Persetujuan Bahan Pekerjaan Rigid Pavement',
        ),
        body: Container(
          ...
          floatingActionButton: BubbleButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const ApprovalMaterialRigidFormPage()));
              },
            ),
    )
    );
