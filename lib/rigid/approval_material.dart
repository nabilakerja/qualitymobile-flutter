...
class ApprovalMaterialRigidFormPage extends StatefulWidget {
  ...
  @override
  _ApprovalMaterialRigidFormPageState createState() =>
      _ApprovalMaterialRigidFormPageState();
}

class _ApprovalMaterialRigidFormPageState
    extends State<ApprovalMaterialRigidFormPage> {
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    inputFile(
                        label: "Kelas Beton"), // Kelas Beton Hanya "Kelas P"
